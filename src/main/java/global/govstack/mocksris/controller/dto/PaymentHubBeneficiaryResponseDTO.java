...
public class PaymentHubBeneficiaryResponseDTO {
    ...
    public PaymentHubBeneficiaryResponseDTO(String responseCode, String responseDescription, String requestID) {
    ...
    @Size(min=20,max=20)   public String getResponseCode() {
        return responseCode;
    }
    ...
    @Size(min=2,max=2)   public String getResponseDescription() {
    ...
    @Size(max=30)   public String getRequestID() {
        return requestID;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentHubBeneficiaryResponseDTO paymentHubBeneficiaryResponseDTO = (PaymentHubBeneficiaryResponseDTO) o;
        return Objects.equals(this.responseCode, paymentHubBeneficiaryResponseDTO.responseCode) &&
                Objects.equals(this.responseDescription, paymentHubBeneficiaryResponseDTO.responseDescription) &&
