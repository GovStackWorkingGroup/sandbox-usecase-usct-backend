...
public class PaymentHubOnboardingBeneficiaryDTO {
    ...
    public PaymentHubOnboardingBeneficiaryDTO(String requestID, List<PaymentHubOnboardingBeneficiaryDetailsDTO> beneficiaries) {
    ...
    public PaymentHubOnboardingBeneficiaryDTO beneficiaries(List<PaymentHubOnboardingBeneficiaryDetailsDTO> beneficiaries) {
        this.beneficiaries = beneficiaries;
        return this;
    }

    public PaymentHubOnboardingBeneficiaryDTO addBeneficiariesItem(PaymentHubOnboardingBeneficiaryDetailsDTO beneficiariesItem) {
    ...
    public boolean equals(Object o) {
        ...
        PaymentHubOnboardingBeneficiaryDTO paymentOnboardingBeneficiaryDTO = (PaymentHubOnboardingBeneficiaryDTO) o;
