...
public class PaymentOnboardingBeneficiaryDTO {
    ...
    public PaymentOnboardingBeneficiaryDTO(String requestID, String sourceBBID, List<PaymentOnboardingBeneficiaryDetailsDTO> beneficiaries) {
    ...
    public PaymentOnboardingBeneficiaryDTO beneficiaries(List<PaymentOnboardingBeneficiaryDetailsDTO> beneficiaries) {
        this.beneficiaries = beneficiaries;
        return this;
    }

    public PaymentOnboardingBeneficiaryDTO addBeneficiariesItem(PaymentOnboardingBeneficiaryDetailsDTO beneficiariesItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PaymentOnboardingBeneficiaryDTO paymentOnboardingBeneficiaryDTO = (PaymentOnboardingBeneficiaryDTO) o;
