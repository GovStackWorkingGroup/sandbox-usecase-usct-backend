...
public class PaymentHubOnboardingBeneficiaryDetailsDTO {
    ...
    public PaymentHubOnboardingBeneficiaryDetailsDTO(String payeeIdentity, String financialModality, String financialAddress, String bankingInstitutionCode) {
    ...
    public PaymentHubOnboardingBeneficiaryDetailsDTO(String payeeIdentity, String financialModality, String financialAddress) {
        this.payeeIdentity = payeeIdentity;
        this.paymentModality = financialModality;
        this.financialAddress = financialAddress;
    }
    ...
    @Size(min=20,max=20)   public String getPayeeIdentity() {
        return payeeIdentity;
    }
    ...
    public PaymentHubOnboardingBeneficiaryDetailsDTO bankingInstitutionCode(String bankingInstitutionCode) {
        this.bankingInstitutionCode = bankingInstitutionCode;
        return this;
    }
    ...
    @Size(max=30)   public String getBankingInstitutionCode() {
        return bankingInstitutionCode;
    }
    ...
    public boolean equals(Object o) {
        ...
        PaymentHubOnboardingBeneficiaryDetailsDTO paymentOnboardingBeneficiaryDetailsDTO = (PaymentHubOnboardingBeneficiaryDetailsDTO) o;
        return Objects.equals(this.payeeIdentity, paymentOnboardingBeneficiaryDetailsDTO.payeeIdentity) &&
                Objects.equals(this.paymentModality, paymentOnboardingBeneficiaryDetailsDTO.paymentModality) &&
                Objects.equals(this.financialAddress, paymentOnboardingBeneficiaryDetailsDTO.financialAddress)&&
                Objects.equals(this.bankingInstitutionCode, paymentOnboardingBeneficiaryDetailsDTO.bankingInstitutionCode);
    }
    ...
    public String toString() {
        ...
        sb.append("    bankingInstitutionCode: ").append(toIndentedString(bankingInstitutionCode)).append("\n");
        sb.append("}");
        return sb.toString();
    }
