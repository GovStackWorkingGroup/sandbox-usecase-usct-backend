...
public class PaymentRestController {
    ...
    public void beneficiaryRegisterOnboardingCB(@RequestBody final PaymentHubBeneficairyOnboardingCallbackDTO beneficiaryCBDto) {
    ...
    @ResponseStatus(HttpStatus.OK)
    public void beneficiaryUpdateOnboardingCB(@RequestBody final PaymentHubBeneficairyOnboardingCallbackDTO beneficiaryCBDto) {
        beneficiaryOnboardingCB(beneficiaryCBDto, PaymentOnboardingCallbackMode.UPDATE);
    }

    private void beneficiaryOnboardingCB(final PaymentHubBeneficairyOnboardingCallbackDTO beneficiaryCBDto,PaymentOnboardingCallbackMode mode){
        var failedBeneficiaries = beneficiaryCBDto.failedCases()
                .stream()
                .map(PaymentHubBeneficairyOnboardingFailedCallbackDTO::payeeIdentity)
                .toList();
        paymentService.updatePaymentOnboardingStatus(failedBeneficiaries, beneficiaryCBDto.requestID(), mode);
    }
