...
public class PaymentEmulatorService implements PaymentService {
    ...
    public PaymentEmulatorService(PaymentBBInformationMediatorProperties paymentBBInformationMediatorproperties, PaymentProperties paymentProperties) {
    ...
    private PaymentOnboardingBeneficiaryDTO convertBeneficiary(List<Beneficiary> beneficiaries, String requestID) {
        var beneficiaryDTO = beneficiaries.stream().map(beneficiary ->
        ...
        var paymentDto = new PaymentOnboardingBeneficiaryDTO(requestID, paymentProperties.sourceBbId(), beneficiaryDTO);
        return paymentDto;
    }
