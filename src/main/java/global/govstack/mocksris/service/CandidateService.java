...
public class CandidateService {
    ...
    public CandidateService(CandidateRepository candidateRepository, PersonService personService, ModelMapper modelMapper) {
    ...
    public Candidate save(CreateCandidateDto createCandidateDto) {
        ...
        Set<Package> packages = createCandidateDto
                .packages()
                .stream()
