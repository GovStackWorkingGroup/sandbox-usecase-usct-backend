        ...
        .authorizeHttpRequests(
            authorize ->
                authorize
                    ...
                    .requestMatchers(HttpMethod.GET, "/api/v1/payment/payment-orders")
                    .hasAnyAuthority(ROLE + ENROLLMENT_OFFICER, ROLE + REGISTRY_ADMINISTRATION)
                    .requestMatchers("/api/v1/callback")
                    .permitAll()
                    .requestMatchers("/api/v1/payment/beneficiary-register-callback")
                    .permitAll()
                    .requestMatchers("/api/v1/payment/beneficiary-update-callback")
                    .permitAll()
                    .requestMatchers("/api/v1/payment/payment-callback")
                    .permitAll()
                    .anyRequest()
                    .authenticated())
        .sessionManagement(
